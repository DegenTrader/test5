            ...
            (async () => {
                ...
                while (true) {
                    try {
                        ...
                        this.updateProgress(Object.assign(Object.assign({}, this.progress), { status: ChainTransactionStatus.Reverted }));
                        if (errors_1.ErrorWithCode.isErrorWithCode(error) &&
                            error.code === errors_1.RenJSError.CHAIN_TRANSACTION_REVERTED) {
                            throw error;
                        }
                        console.error(error);
                    }
