...
export interface ChainCommon {
    ...
    transactionConfidence: (transaction: ChainTransaction) => SyncOrPromise<BigNumber>;
    ...
    transactionExplorerLink: (transaction: Partial<ChainTransaction> & ({
        txid: string;
    } | {
        txHash: string;
    })) => string | undefined;
    populateChainTransaction: (partialTx: Partial<ChainTransaction> & ({
        txid: string;
    } | {
        txHash: string;
    })) => ChainTransaction;
}
export interface DepositChain<FromPayload extends {
    chain: string;
    txConfig?: any;
} = any, ToPayload extends {
    chain: string;
    txConfig?: any;
} = any> extends ChainCommon {
     ...
     */
    createGatewayAddress: (asset: string, fromPayload: FromPayload, shardPublicKey: Uint8Array, gHash: Uint8Array) => SyncOrPromise<string>;
    /** Watch for deposits made to the provided address. */
    watchForDeposits?: (asset: string, fromPayload: FromPayload, address: string, onInput: (input: InputChainTransaction) => void, removeInput: (input: InputChainTransaction) => void, listenerCancelled: () => boolean) => Promise<void>;
    /** Return toPayload in standard to/payload format. */
    getOutputPayload: (asset: string, inputType: InputType, outputType: OutputType, toPayload: ToPayload) => SyncOrPromise<{
        to: string;
        toBytes: Uint8Array;
        payload: Uint8Array;
    } | undefined>;
}
export declare const isDepositChain: (chain: any) => chain is DepositChain<any, any>;
export interface ContractChain<FromContractCall extends {
    chain: string;
    txConfig?: any;
} = any, ToContractCall extends {
    chain: string;
    txConfig?: any;
} = FromContractCall> extends ChainCommon {
    /** Return true if the asset originates from the chain. */
    isLockAsset: (asset: string) => SyncOrPromise<boolean>;
    ...
    getInSetup?: (asset: string, inputType: InputType, outputType: OutputType, contractCall: FromContractCall, getParams: () => {
        toChain: string;
        toPayload: {
            to: string;
            toBytes: Uint8Array;
    ...
    getOutSetup?: (asset: string, inputType: InputType, outputType: OutputType, contractCall: ToContractCall, getParams: () => {
        pHash: Uint8Array;
        nHash: Uint8Array;
        amount?: BigNumber;
        sigHash?: Uint8Array;
     ...
     * in the transaction.
     */
    getInputTx: (inputType: InputType, outputType: OutputType, asset: string, contractCall: FromContractCall, getParams: () => {
        toChain: string;
        toPayload: {
            to: string;
            toBytes: Uint8Array;
        ...
        gatewayAddress?: string;
    }, confirmationTarget: number, onInput: (input: InputChainTransaction) => void, removeInput: (input: InputChainTransaction) => void) => SyncOrPromise<TxSubmitter | TxWaiter>;
    /**
     ...
     */
    getOutputTx: (inputType: InputType, outputType: OutputType, asset: string, contractCall: ToContractCall, params: () => {
        sHash: Uint8Array;
        pHash: Uint8Array;
        nHash: Uint8Array;
        amount?: BigNumber;
        sigHash?: Uint8Array;
        signature?: Uint8Array;
    }, confirmationTarget: number) => SyncOrPromise<TxSubmitter | TxWaiter>;
    getOutputPayload: (asset: string, inputType: InputType, outputType: OutputType, contractCall: ToContractCall) => SyncOrPromise<{
        to: string;
        toBytes: Uint8Array;
        payload: Uint8Array;
    } | undefined>;
}
export declare const isContractChain: (chain: any) => chain is ContractChain<any, any>;
export declare type Chain<FromPayload extends {
    chain: string;
    txConfig?: any;
} = any, ToPayload extends {
    chain: string;
    txConfig?: any;
} = FromPayload> = DepositChain<FromPayload, ToPayload> | ContractChain<FromPayload, ToPayload>;
