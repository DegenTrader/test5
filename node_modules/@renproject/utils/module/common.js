...
export const EMPTY_SIGNATURE = "AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA";
export const isEmptySignature = (sig) => utils.toURLBase64(sig) === EMPTY_SIGNATURE;
/**
...
export const normalizeSignature = (signature) => {
    utils.assertType("Uint8Array", { signature });
...
export const populateChainTransaction = ({ partialTx, chain, txHashToBytes, txHashFromBytes, explorerLink, defaultTxindex, }) => {
