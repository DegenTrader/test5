...
export class Ethereum extends EthereumBaseChain {
    ...
    constructor(_a) {
        ...
        super(Object.assign(Object.assign({}, params), { network: resolveEVMNetworkConfig(defaultTestnet === EthereumTestnet.Görli
                ? goerliConfigMap
                : defaultConfigMap, network) }));
...
Ethereum.configMap = defaultConfigMap;
