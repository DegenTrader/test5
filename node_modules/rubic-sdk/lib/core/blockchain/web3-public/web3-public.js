...
var Web3Public = /** @class */ (function () {
    ...
    Web3Public.prototype.getTokensBalances = function (address, tokensAddresses) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        if (multicall_addresses_1.MULTICALL_ADDRESSES[this.blockchainName] === 'NONE') {
                            return [2 /*return*/, new Array(tokensAddresses.length).fill(new bignumber_js_1.default(0))];
                        }
    ...
    Web3Public.prototype.callForTokenInfo = function (tokenAddress, tokenFields) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            var nativeToken, conditionalReturns_1, tokenFieldsR, notSave, tokenInfo, conditionalReturns;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        if (web3_pure_1.Web3Pure.isNativeAddress(tokenAddress)) {
                            nativeToken = native_tokens_1.nativeTokensList[this.blockchainName];
                            conditionalReturns_1 = {
                                notSave: false,
                                value: __assign(__assign({}, nativeToken), { decimals: nativeToken.decimals.toString() })
                            };
                            // see https://github.com/microsoft/TypeScript/issues/4881
                            // @ts-ignore
                            return [2 /*return*/, conditionalReturns_1];
                        }
                        return [4 /*yield*/, this.multicallContractMethods(tokenAddress, erc_20_abi_1.ERC20_TOKEN_ABI, tokenFields.map(function (methodName) { return ({
                                methodName: methodName,
                                methodArguments: []
                            }); }))];
                    case 1:
                        tokenFieldsR = _a.sent();
                        notSave = false;
                        tokenInfo = tokenFieldsR.reduce(function (acc, field, index) {
                            var _a;
                            var _b;
                            if (!field.success) {
                                notSave = true;
                            ...
                            return __assign(__assign({}, acc), (_a = {}, _a[fieldName] = field.success ? (_b = field.output) === null || _b === void 0 ? void 0 : _b[0] : undefined, _a));
                        }, {});
                        conditionalReturns = {
                            notSave: notSave,
                            value: tokenInfo
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        results = _a.sent();
                        notSave = false;
                        tokensInfo = results.map(function (contractCallResult, index) {
                            var tokenAddress = tokenAddresses[index];
                            if (web3_pure_1.Web3Pure.isNativeAddress(tokenAddress)) {
                                var nativeToken = native_tokens_1.nativeTokensList[_this.blockchainName];
                                return __assign(__assign({}, nativeToken), { decimals: nativeToken.decimals.toString(), totalSupply: undefined });
                            }
                            var token = {};
                            contractCallResult.forEach(function (field, fieldIndex) {
                                var _a;
                                token[tokenFields[fieldIndex]] = field.success
