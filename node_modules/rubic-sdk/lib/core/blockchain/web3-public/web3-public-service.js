...
var Web3PublicService = /** @class */ (function () {
    ...
    Web3PublicService.prototype.parseRpcList = function (rpcList) {
        return Object.keys(rpcList).reduce(function (acc, blockchainName) {
            var _a;
            var _b;
            var rpcConfig = rpcList[blockchainName];
            var list;
            if (rpcConfig.mainRpc) {
                list = [rpcConfig.mainRpc].concat(rpcConfig.spareRpc ? [rpcConfig.spareRpc] : []);
            }
            else {
                if (!((_b = rpcConfig.rpcList) === null || _b === void 0 ? void 0 : _b.length)) {
                    console.error("For ".concat(blockchainName, " you must provide either 'mainRpc' or 'rpcList' field"));
                    return acc;
                }
            ...
            return __assign(__assign({}, acc), (_a = {}, _a[blockchainName] = rpcProvider, _a));
        }, {});
    };
    ...
    Web3PublicService.prototype.createAndCheckWeb3Public = function () {
        var _this = this;
        Object.keys(this.rpcListProvider).forEach(function (blockchainName) {
            return (_this.web3PublicStorage[blockchainName] =
                _this.createWeb3PublicProxy(blockchainName));
        });
    };
    Web3PublicService.prototype.createWeb3PublicProxy = function (blockchainName) {
        var rpcProvider = this.rpcListProvider[blockchainName];
        var web3Public = new web3_public_1.Web3Public(new web3_1.default(rpcProvider.rpcList[0]), blockchainName);
            ...
            get: function (target, prop) {
                ...
                if (typeof target[prop] === 'function') {
                    return function method() {
                        ...
                        return __awaiter(this, void 0, void 0, function () {
                            var curRpc, methodParams, callMethod, e_1, nextRpc;
                            return __generator(this, function (_b) {
                                switch (_b.label) {
                                    case 0:
                                        curRpc = rpcProvider.rpcList[0];
                                        methodParams = structuredClone(params);
                                        callMethod = function () {
                                            var _a;
                                    ...
                                    case 3:
                                        ...
                                        if (e_1 instanceof timeout_error_1.TimeoutError ||
                                            ((_a = e_1.message) === null || _a === void 0 ? void 0 : _a.toLowerCase().includes(curRpc.toLowerCase()))) {
                                            if (curRpc === rpcProvider.rpcList[0]) {
                                                rpcProvider.rpcList.shift();
                                                if (!rpcProvider.rpcList.length) {
                                                    throw new rubic_sdk_error_1.RubicSdkError("No working rpc is left for ".concat(blockchainName, "."));
                                                }
                                                nextRpc = rpcProvider.rpcList[0];
                                                web3Public.setProvider(nextRpc);
                                                console.debug("Rpc provider for ".concat(blockchainName, " is changed to ").concat(nextRpc, "."));
                                            }
                                            return [2 /*return*/, method.apply(void 0, methodParams)];
                                        }
                                        throw e_1;
