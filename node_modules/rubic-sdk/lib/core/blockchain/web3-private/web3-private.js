...
var Web3Private = /** @class */ (function () {
    ...
    Web3Private.parseError = function (err) {
        ...
        if (err.message.includes('execution reverted: Address: low-level call with value failed')) {
            return new common_1.InsufficientFundsGasPriceValueError();
        }
    ...
    Web3Private.prototype.checkBlockchainCorrect = function (blockchainName) {
        return __awaiter(this, void 0, void 0, function () {
            var userChainId, userBlockchain;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.web3.eth.getChainId()];
                    case 1:
                        userChainId = _a.sent();
                        userBlockchain = core_1.BlockchainsInfo.getBlockchainById(userChainId);
                        if ((userBlockchain === null || userBlockchain === void 0 ? void 0 : userBlockchain.name) !== blockchainName) {
