...
var UniswapV2AbstractTrade = /** @class */ (function (_super) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.needApprove(options.fromAddress)];
                    case 1:
                        if (_a.sent()) {
                    ...
                    case 4:
                        _err_1 = _a.sent();
                        throw new rubic_sdk_error_1.RubicSdkError('To use `encode` function, wallet must have enough balance or you must provider `supportFee` parameter in options.');
    ...
    UniswapV2AbstractTrade.prototype.getCallParameters = function (receiverAddress) {
    ...
    UniswapV2AbstractTrade.prototype.getSwapParametersByMethod = function (method, options) {
        ...
        return [
            ...
            method,
            this.getCallParameters(options === null || options === void 0 ? void 0 : options.receiverAddress),
            __assign(__assign({ onTransactionHash: options.onConfirm, value: value }, (method === this.regularSwapMethod && { gas: gas })), { gasPrice: gasPrice })
        ];
    };
