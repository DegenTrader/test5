            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.web3Public.getAllowance(this.nativeSupportedFrom.address, this.walletAddress, this.contractAddress)];
                    case 1:
                        allowance = _a.sent();
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 3:
                        _b.trys.push([3, 5, , 6]);
                        return [4 /*yield*/, this.getTradeData(false, undefined, options.receiverAddress).catch(function (err) {
                                var _a, _b;
