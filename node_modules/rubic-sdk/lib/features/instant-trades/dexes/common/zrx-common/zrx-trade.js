...
var ZrxTrade = /** @class */ (function (_super) {
    ...
    function ZrxTrade(tradeStruct) {
        ...
        _this.apiTradeData = tradeStruct.apiTradeData;
        _this.contractAddress = _this.apiTradeData.to;
        _this.path = tradeStruct.path;
        return _this;
    }
    Object.defineProperty(ZrxTrade.prototype, "type", {
        get: function () {
    ...
    ZrxTrade.prototype.swap = function (options) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        if (options === null || options === void 0 ? void 0 : options.receiverAddress) {
                            throw new common_1.UnsupportedReceiverAddressError();
                        }
                        return [4 /*yield*/, this.checkWalletState()];
                    case 1:
                        _b.sent();
                        return [4 /*yield*/, this.checkAllowanceAndApprove(options)];
                    case 2:
                        _b.sent();
                        _a = this.getGasParams(options), gas = _a.gas, gasPrice = _a.gasPrice;
    ...
    ZrxTrade.prototype.encode = function (options) {
        return __awaiter(this, void 0, void 0, function () {
            var _a, gas, gasPrice;
            return __generator(this, function (_b) {
                _a = this.getGasParams(options), gas = _a.gas, gasPrice = _a.gasPrice;
