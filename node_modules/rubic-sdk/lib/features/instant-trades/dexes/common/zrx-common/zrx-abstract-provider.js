...
var ZrxAbstractProvider = /** @class */ (function (_super) {
    ...
    Object.defineProperty(ZrxAbstractProvider.prototype, "type", {
        get: function () {
    ...
    ZrxAbstractProvider.prototype.calculate = function (from, to, options) {
        return __awaiter(this, void 0, void 0, function () {
            var fullOptions, fromClone, toClone, affiliateAddress, quoteParams, apiTradeData, tradeStruct, gasPriceInfo, gasFeeInfo;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        affiliateAddress = fullOptions.zrxAffiliateAddress;
                        quoteParams = {
                            params: __assign({ sellToken: fromClone.address, buyToken: toClone.address, sellAmount: fromClone.stringWeiAmount, slippagePercentage: fullOptions.slippageTolerance.toString() }, (affiliateAddress && { affiliateAddress: affiliateAddress }))
                        };
