...
export declare type RequiredCrossChainOptions = MarkRequired<CrossChainOptions, 'fromSlippageTolerance' | 'toSlippageTolerance' | 'slippageTolerance' | 'deadline' | 'providerAddress' | 'timeout' | 'toAddress'>;
