import { CrossChainTradeData, CrossChainTxStatus } from "../..";
...
export declare type getDstTxDataFn = (data: CrossChainTradeData, srcTxReceipt: TransactionReceipt) => Promise<DstTxData>;
