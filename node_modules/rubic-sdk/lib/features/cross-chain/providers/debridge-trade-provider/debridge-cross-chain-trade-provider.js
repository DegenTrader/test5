...
var DebridgeCrossChainTradeProvider = /** @class */ (function (_super) {
    ...
    DebridgeCrossChainTradeProvider.prototype.calculate = function (from, toToken, options) {
        return __awaiter(this, void 0, void 0, function () {
            var fromBlockchain, toBlockchain, fromAddress, feeInfo, fromWithoutFee, slippageTolerance, requestParams, _a, tx, estimation, to, gasData, _b, transitToken, cryptoFeeAmount, nativeToken, cryptoFeeToken, err_1, rubicSdkError, debridgeApiError;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, this.checkContractState(fromBlockchain, contract_address_1.DE_BRIDGE_CONTRACT_ADDRESS[fromBlockchain].rubicRouter)];
                    case 2:
                        _c.sent();
                    ...
                    case 9:
                        ...
                        debridgeApiError = this.parseDebridgeApiError(err_1);
                        return [2 /*return*/, {
                                trade: null,
    ...
    DebridgeCrossChainTradeProvider.prototype.parseDebridgeApiError = function (httpErrorResponse) {
        if (httpErrorResponse.error.errorId === 'INCLUDED_GAS_FEE_NOT_COVERED_BY_INPUT_AMOUNT') {
            return new too_low_amount_error_1.TooLowAmountError();
        }
