...
var debridge_cross_chain_trade_provider_1 = require("./debridge-cross-chain-trade-provider");
/**
 * Calculated DeBridge cross chain trade.
 */
var DebridgeCrossChainTrade = /** @class */ (function (_super) {
    __extends(DebridgeCrossChainTrade, _super);
    function DebridgeCrossChainTrade(crossChainTrade, providerAddress) {
        ...
        _this.transactionRequest = crossChainTrade.transactionRequest;
        ...
        _this.itType = { from: features_1.TRADE_TYPE.ONE_INCH, to: features_1.TRADE_TYPE.ONE_INCH };
        _this.fromWeb3Public = injector_1.Injector.web3PublicService.getWeb3Public(_this.from.blockchain);
        return _this;
    }
    /** @internal */
    DebridgeCrossChainTrade.getGasData = function (from, to, transactionRequest) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_g) {
                switch (_g.label) {
                    ...
                    case 1:
                        _g.trys.push([1, 5, , 6]);
                        return [4 /*yield*/, new DebridgeCrossChainTrade({
                                from: from,
                                to: to,
    ...
    Object.defineProperty(DebridgeCrossChainTrade.prototype, "fromBlockchain", {
        get: function () {
    ...
    Object.defineProperty(DebridgeCrossChainTrade.prototype, "fromContractAddress", {
        get: function () {
    ...
    DebridgeCrossChainTrade.prototype.swap = function (options) {
    ...
    DebridgeCrossChainTrade.prototype.getContractParams = function (options) {
        return __awaiter(this, void 0, void 0, function () {
            var _a, data, providerValue, toChainId, fromContracts, swapArguments, methodArguments, value;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0: return [4 /*yield*/, this.getTransactionRequest(options === null || options === void 0 ? void 0 : options.receiverAddress)];
                    case 1:
                        _a = _b.sent(), data = _a.data, providerValue = _a.value;
                        toChainId = core_1.BlockchainsInfo.getBlockchainByName(this.to.blockchain).id;
                        fromContracts = contract_address_1.DE_BRIDGE_CONTRACT_ADDRESS[this.from.blockchain];
                        swapArguments = [
                            this.from.address,
                        ...
                        methodArguments = ["native:".concat(this.type.toLowerCase()), swapArguments];
    ...
    DebridgeCrossChainTrade.prototype.getTradeAmountRatio = function (fromUsd) {
    ...
    DebridgeCrossChainTrade.prototype.getTransactionRequest = function (receiverAddress) {
        return __awaiter(this, void 0, void 0, function () {
            var params, tx;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        params = __assign(__assign({}, this.transactionRequest), (receiverAddress && { dstChainTokenOutRecipient: receiverAddress }));
                        return [4 /*yield*/, injector_1.Injector.httpClient.get(debridge_cross_chain_trade_provider_1.DebridgeCrossChainTradeProvider.apiEndpoint, { params: params })];
                    case 1:
                        tx = (_a.sent()).tx;
                        return [2 /*return*/, tx];
                }
    ...
    return DebridgeCrossChainTrade;
