...
var LifiCrossChainTradeProvider = /** @class */ (function (_super) {
    ...
    LifiCrossChainTradeProvider.prototype.calculate = function (from, toToken, options) {
        return __awaiter(this, void 0, void 0, function () {
            var fromBlockchain, toBlockchain, routeOptions, fromChainId, toChainId, feeInfo, fromWithoutFee, fromAddress, toAddress, routesRequest, result, routes, bestRoute, fromAmountUSD, toAmountUSD, priceImpact, to, gasData, _a, _b, itType, bridgeType, trade;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.checkContractState(fromBlockchain, lifi_contract_data_1.lifiContractAddress[fromBlockchain].rubicRouter)];
                    case 1:
                        _c.sent();
                        routeOptions = {
                    ...
                    case 2:
                        ...
                        routesRequest = __assign(__assign({ fromChainId: fromChainId, fromAmount: fromWithoutFee.stringWeiAmount, fromTokenAddress: from.address, toChainId: toChainId, toTokenAddress: toToken.address, options: routeOptions }, (fromAddress && { fromAddress: fromAddress })), (toAddress && { toAddress: toAddress }));
                        return [4 /*yield*/, this.lifi.getRoutes(routesRequest)];
                    case 3:
                        result = _c.sent();
                        routes = result.routes;
                        bestRoute = routes.find(function (route) { return route.steps.length === 1 && !route.containsSwitchChain; });
                        if (!bestRoute) {
                            return [2 /*return*/, null];
                        }
