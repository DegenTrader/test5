...
var CrossChainTrade = /** @class */ (function () {
    ...
    CrossChainTrade.prototype.checkBlockchainCorrect = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, injector_1.Injector.web3Private.checkBlockchainCorrect(this.from.blockchain)];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
    ...
    CrossChainTrade.prototype.getSwapValue = function (providerValue) {
        var _a, _b, _c;
        var fixedFeeValue = core_1.Web3Pure.toWei(((_b = (_a = this.feeInfo) === null || _a === void 0 ? void 0 : _a.fixedFee) === null || _b === void 0 ? void 0 : _b.amount) || 0);
        var fromValue;
        if (this.from.isNative) {
            if (providerValue) {
                fromValue = new bignumber_js_1.default(providerValue).dividedBy(1 - (((_c = this.feeInfo.platformFee) === null || _c === void 0 ? void 0 : _c.percent) || 0) / 100);
            }
            else {
