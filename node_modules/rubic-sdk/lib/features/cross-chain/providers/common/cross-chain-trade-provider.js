...
var common_cross_chain_abi_1 = require("./constants/common-cross-chain-abi");
var CrossChainTradeProvider = /** @class */ (function () {
    ...
    Object.defineProperty(CrossChainTradeProvider.prototype, "walletAddress", {
        get: function () {
    ...
    CrossChainTradeProvider.prototype.checkContractState = function (fromBlockchain, rubicRouter) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        web3PublicService = injector_1.Injector.web3PublicService.getWeb3Public(fromBlockchain);
                        return [4 /*yield*/, web3PublicService.callContractMethod(rubicRouter, common_cross_chain_abi_1.commonCrossChainAbi, 'paused')];
                    case 1:
                        isPaused = _a.sent();
                        if (isPaused) {
