...
exports.CelerCrossChainTrade = void 0;
...
var celer_cross_chain_fee_multipliers_1 = require("./constants/celer-cross-chain-fee-multipliers");
 ...
 */
var CelerCrossChainTrade = /** @class */ (function (_super) {
    __extends(CelerCrossChainTrade, _super);
    function CelerCrossChainTrade(crossChainTrade, providerAddress, maxSlippage) {
        var _this = _super.call(this, providerAddress) || this;
        _this.maxSlippage = maxSlippage;
        ...
        var fromSlippage = _this.fromTrade instanceof celer_it_cross_chain_contract_trade_1.CelerItCrossChainContractTrade ? _this.fromTrade.slippage : 0;
        ...
        _this.itType = {
            from: crossChainTrade.fromTrade instanceof celer_direct_cross_chain_contract_trade_1.CelerDirectCrossChainContractTrade
                ? undefined
                : crossChainTrade.fromTrade.provider.type,
            to: crossChainTrade.toTrade instanceof celer_direct_cross_chain_contract_trade_1.CelerDirectCrossChainContractTrade
                ? undefined
    ...
    /** @internal */
    CelerCrossChainTrade.getGasData = function (fromTrade, toTrade, cryptoFeeToken, maxSlippage) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_g) {
                switch (_g.label) {
                    ...
                    case 1:
                        _g.trys.push([1, 5, , 6]);
                        return [4 /*yield*/, new CelerCrossChainTrade({
                                fromTrade: fromTrade,
                                toTrade: toTrade,
                            ...
                            }, empty_address_1.EMPTY_ADDRESS, maxSlippage).getContractParams({})];
                    case 2:
    ...
    CelerCrossChainTrade.prototype.checkTradeErrors = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        this.checkWalletConnected();
                        return [4 /*yield*/, this.checkBlockchainCorrect()];
                    case 1:
                        _a.sent();
    ...
    CelerCrossChainTrade.prototype.swap = function (options) {
    ...
    CelerCrossChainTrade.prototype.parseSwapErrors = function (err) {
        var _a;
    ...
    CelerCrossChainTrade.prototype.getContractParams = function (options) {
        if (options === void 0) { options = {}; }
        return __awaiter(this, void 0, void 0, function () {
            var fromTrade, toTrade, contractAddress, _a, methodName, contractAbi, methodArguments, tokenInAmountAbsolute, msgValue, value;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        fromTrade = this.fromTrade;
                        toTrade = this.toTrade;
                        contractAddress = fromTrade.contract.address;
                        _a = fromTrade.getMethodNameAndContractAbi(), methodName = _a.methodName, contractAbi = _a.contractAbi;
                    ...
                    case 1:
                        methodArguments = _b.sent();
                        tokenInAmountAbsolute = fromTrade.fromToken.weiAmount;
                        return [4 /*yield*/, this.calculateSwapValue(tokenInAmountAbsolute, methodArguments)];
                    case 2:
                        msgValue = _b.sent();
                        value = new bignumber_js_1.default(msgValue).toFixed(0);
                        return [2 /*return*/, {
    ...
    CelerCrossChainTrade.prototype.calculateSwapValue = function (amountIn, data) {
        var _a;
        return __awaiter(this, void 0, void 0, function () {
            var contract, isNative, isBridge, isToTransit, message, messageBusAddress, cryptoFee, feePerByte, feeBase, fixedFee, adjustedFeeBase, adjustedFeeBase;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        contract = this.fromTrade.contract;
                        isNative = this.fromTrade.fromToken.isNative;
                        isBridge = this.fromTrade.fromToken.isEqualTo(this.fromTrade.toToken);
                        isToTransit = this.toTrade.fromToken.isEqualTo(this.toTrade.toToken);
                        message = web3_pure_1.Web3Pure.asciiToBytes32(JSON.stringify(data));
                        return [4 /*yield*/, contract.messageBusAddress()];
                    case 1:
                        messageBusAddress = _b.sent();
                        return [4 /*yield*/, contract.destinationCryptoFee(this.toTrade.blockchain)];
                    case 2:
                        cryptoFee = _b.sent();
                        return [4 /*yield*/, contract.celerFeePerByte(message, messageBusAddress)];
                    case 3:
                        feePerByte = _b.sent();
                        return [4 /*yield*/, contract.celerFeeBase(messageBusAddress)];
                    case 4:
                        feeBase = _b.sent();
                        fixedFee = web3_pure_1.Web3Pure.toWei(((_a = this.feeInfo.fixedFee) === null || _a === void 0 ? void 0 : _a.amount) || 0);
                        if (isNative) {
                            return [2 /*return*/, amountIn
                                    .plus(feePerByte)
                                    .plus(cryptoFee)
                                    .plus(feeBase)
                                    .plus(fixedFee)
                        ...
                        if (isBridge) {
                            adjustedFeeBase = Number(feeBase) * celer_cross_chain_fee_multipliers_1.celerSourceTransitTokenFeeMultiplier;
                            return [2 /*return*/, Number(feePerByte) + Number(cryptoFee) + Number(fixedFee) + adjustedFeeBase];
                        }
                        if (isToTransit) {
                            adjustedFeeBase = Number(feePerByte) * celer_cross_chain_fee_multipliers_1.celerTargetTransitTokenFeeMultiplier;
                            return [2 /*return*/, Number(feeBase) + Number(cryptoFee) + Number(fixedFee) + adjustedFeeBase];
                        }
                        return [2 /*return*/, Number(feePerByte) + Number(cryptoFee) + Number(feeBase) + Number(fixedFee)];
                }
            });
        });
    };
    return CelerCrossChainTrade;
}(celer_rubic_cross_chain_trade_1.CelerRubicCrossChainTrade));
exports.CelerCrossChainTrade = CelerCrossChainTrade;
//# sourceMappingURL=celer-cross-chain-trade.js.map