                ...
                switch (_o.label) {
                    ...
                    case 7:
                        ...
                        if (estimateTransitAmountWithSlippage.lte(0)) {
                            return [2 /*return*/, {
                                    trade: null,
                                    error: new too_low_amount_error_1.TooLowAmountError()
                                }];
                        }
                        return [4 /*yield*/, this.getToTransitTokenAmount(toBlockchain, fromTrade.fromToken, estimateTransitAmountWithSlippage, fromTrade.contract)];
                    case 8:
                    ...
                    case 10:
                        ...
                        if (!cryptoFeeToken.tokenAmount.gt(0)) return [3 /*break*/, 12];
                    ...
                    case 12:
                        ...
                        if (!(gasCalculation === 'enabled')) return [3 /*break*/, 14];
