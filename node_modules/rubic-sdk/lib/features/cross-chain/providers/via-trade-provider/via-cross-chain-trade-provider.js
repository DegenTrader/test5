...
var ViaCrossChainTradeProvider = /** @class */ (function (_super) {
    ...
    ViaCrossChainTradeProvider.prototype.calculate = function (from, toToken, options) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            var fromBlockchain, toBlockchain, fromChainId, toChainId, feeInfo, fromWithoutFee, via, fromAddress, toAddress, params, wrappedRoutes, routes, _b, fromTokenPrice, nativeTokenPrice, bestRoute, to, toTokenAmountMin, gasData, _c, additionalFee, cryptoFeeAmount, cryptoFeeSymbol, nativeToken, cryptoFeeToken, itType, bridgeType, err_1;
            var _this = this;
            return __generator(this, function (_d) {
                switch (_d.label) {
                    ...
                    case 2:
                        ...
                        via = new router_sdk_1.Via(__assign(__assign({}, via_default_api_key_1.VIA_DEFAULT_CONFIG), { timeout: options.timeout }));
                        fromAddress = this.walletAddress;
                        toAddress = options.receiverAddress || this.walletAddress;
                        params = __assign(__assign(__assign({ fromChainId: fromChainId, fromTokenAddress: from.address, 
                            // `number` max value is less, than from wei amount
                            fromAmount: fromWithoutFee.stringWeiAmount, toChainId: toChainId, toTokenAddress: toToken.address }, (fromAddress && { fromAddress: fromAddress })), (toAddress && { toAddress: toAddress })), { multiTx: false, limit: 1 });
                        return [4 /*yield*/, via.getRoutes(__assign({}, params))];
                    case 3:
                        wrappedRoutes = _d.sent();
                        routes = wrappedRoutes.routes.filter(function (route) { return _this.parseBridge(route); });
                        if (!routes.length) {
                            return [2 /*return*/, null];
                        }
                    ...
                    case 4:
                        _b = _d.sent(), fromTokenPrice = _b[0], nativeTokenPrice = _b[1];
                    ...
                    case 8:
                        ...
                        feeInfo = __assign(__assign({}, feeInfo), { cryptoFee: additionalFee
                                ? {
                        ...
                        return [2 /*return*/, {
                                ...
                                }, options.providerAddress, injector_1.Injector.web3Private.address)
                            }];
                    case 9:
                        err_1 = _d.sent();
                        return [2 /*return*/, {
