...
var SymbiosisCrossChainTrade = /** @class */ (function (_super) {
    ...
    SymbiosisCrossChainTrade.prototype.getContractParams = function (options) {
        return __awaiter(this, void 0, void 0, function () {
            var exactIn, _a, data, providerValue, toChainId, swapArguments, methodArguments, value;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        exactIn = _b.sent();
                        _a = exactIn.transactionRequest, data = _a.data, providerValue = _a.value;
                        ...
                        value = this.getSwapValue(providerValue === null || providerValue === void 0 ? void 0 : providerValue.toString());
                        return [2 /*return*/, {
