...
var too_low_amount_error_1 = require("../../../../common/errors/cross-chain/too-low-amount.error");
...
var SymbiosisCrossChainTradeProvider = /** @class */ (function (_super) {
    ...
    SymbiosisCrossChainTradeProvider.prototype.calculate = function (from, toToken, options) {
        return __awaiter(this, void 0, void 0, function () {
            var fromBlockchain, toBlockchain, isBitcoinSwap, fromAddress_1, tokenIn, feeInfo, fromWithoutFee, tokenAmountIn_1, tokenOut_1, deadline_1, slippageTolerance_1, bitcoinNullAddress, receiverAddress, _a, tokenAmountOut, priceImpact, transitTokenFee, swapFunction, to, gasData, _b, transitToken, transitAmount, _c, err_1, rubicSdkError, _d;
            var _this = this;
            return __generator(this, function (_e) {
                switch (_e.label) {
                    case 0:
                        ...
                        _e.label = 1;
                    case 1:
                        _e.trys.push([1, 11, , 16]);
                        fromAddress_1 = options.fromAddress || this.walletAddress || constants_1.oneinchApiParams.nativeAddress;
                        return [4 /*yield*/, this.checkContractState(fromBlockchain, contract_address_1.SYMBIOSIS_CONTRACT_ADDRESS[fromBlockchain].rubicRouter)];
                    case 2:
                        _e.sent();
                    ...
                    case 3:
                        ...
                        tokenAmountIn_1 = new symbiosis_js_sdk_1.TokenAmount(tokenIn, fromWithoutFee.stringWeiAmount);
                    ...
                    case 4:
                        _a = _e.sent(), tokenAmountOut = _a.tokenAmountOut, priceImpact = _a.priceImpact, transitTokenFee = _a.transitTokenFee;
                    ...
                    case 11:
                        ...
                        if (!(err_1 instanceof symbiosis_js_sdk_1.Error && err_1.message)) return [3 /*break*/, 15];
                        if (!(err_1.code === symbiosis_js_sdk_1.ErrorCode.AMOUNT_LESS_THAN_FEE)) return [3 /*break*/, 12];
                        _d = new too_low_amount_error_1.TooLowAmountError();
                        return [3 /*break*/, 14];
                    case 12: return [4 /*yield*/, this.checkMinMaxErrors(err_1, from, options.slippageTolerance)];
                    case 13:
                        _d = _e.sent();
                        _e.label = 14;
                    case 14:
    ...
    SymbiosisCrossChainTradeProvider.prototype.checkMinMaxErrors = function (err, from, slippage) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        if (!(err.code === symbiosis_js_sdk_1.ErrorCode.AMOUNT_TOO_LOW)) return [3 /*break*/, 2];
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, swapping.exactIn(swapParams.tokenAmountIn, swapParams.tokenOut, swapParams.fromAddress, swapParams.receiverAddress || swapParams.fromAddress, swapParams.fromAddress, swapParams.slippage, swapParams.deadline, true)];
                    case 1:
                        swapResult = _a.sent();
                        return [3 /*break*/, 7];
                    case 2:
