export declare const BRIDGE_TYPE: {
    ...
    readonly CELER_BRIDGE: "cbridge";
    readonly CONNEXT: "connext";
    readonly DE_BRIDGE: "debridge";
    readonly HOP: "hop";
...
export declare type BridgeType = typeof BRIDGE_TYPE[keyof typeof BRIDGE_TYPE];
export declare const bridges: ("avalanche" | "across" | "anyswap" | "arbitrum" | "cbridge" | "connext" | "debridge" | "hop" | "hyphen" | "openocean" | "maker" | "multichain" | "optimism" | "osmosis" | "polygon" | "refuel" | "satellite" | "stargate" | "symbiosis" | "synapse" | "thorchain" | "wormhole" | "ypool")[];
