...
var timeout_error_1 = require("../errors/utils/timeout.error");
...
var CoingeckoApi = /** @class */ (function () {
    function CoingeckoApi(httpClient) {
        ...
        this.nativeCoinsCoingeckoIds = (_a = {},
            ...
            _a[blockchain_name_1.BLOCKCHAIN_NAME.ARBITRUM] = 'ethereum',
            _a[blockchain_name_1.BLOCKCHAIN_NAME.AURORA] = 'ethereum',
            _a[blockchain_name_1.BLOCKCHAIN_NAME.TELOS] = 'tlos',
            _a[blockchain_name_1.BLOCKCHAIN_NAME.BOBA] = 'ethereum',
            _a[blockchain_name_1.BLOCKCHAIN_NAME.BITCOIN] = 'bitcoin',
            _a[blockchain_name_1.BLOCKCHAIN_NAME.ETHEREUM_POW] = 'ethereum-pow-iou',
            _a);
        this.tokenBlockchainId = (_b = {},
            ...
            _b[blockchain_name_1.BLOCKCHAIN_NAME.ARBITRUM] = 'arbitrum-one',
            _b[blockchain_name_1.BLOCKCHAIN_NAME.AURORA] = 'aurora',
            _b[blockchain_name_1.BLOCKCHAIN_NAME.TELOS] = 'telos',
            _b[blockchain_name_1.BLOCKCHAIN_NAME.BOBA] = 'boba-network',
            _b[blockchain_name_1.BLOCKCHAIN_NAME.BITCOIN] = 'bitcoin',
            _b[blockchain_name_1.BLOCKCHAIN_NAME.ETHEREUM_POW] = 'ethereum-pow-iou',
            _b);
    }
    ...
    CoingeckoApi.prototype.getNativeCoinPrice = function (blockchain) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            var coingeckoId, response, price, err_1;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 2:
                        response = _c.sent();
                        price = (_a = response === null || response === void 0 ? void 0 : response[coingeckoId]) === null || _a === void 0 ? void 0 : _a.usd;
                        if (!price) {
                            throw new rubic_sdk_error_1.RubicSdkError('Coingecko price is not defined');
                        }
                        return [2 /*return*/, new bignumber_js_1.default(price)];
                    case 3:
                        err_1 = _c.sent();
                        if (err_1 instanceof timeout_error_1.TimeoutError) {
                            console.debug('[RUBIC SDK]: Timeout Error. Coingecko cannot retrieve token price');
                        }
                        else if ((_b = err_1 === null || err_1 === void 0 ? void 0 : err_1.message) === null || _b === void 0 ? void 0 : _b.includes('Request failed with status code 429')) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_d) {
                switch (_d.label) {
                    ...
                    case 3:
                        err_2 = _d.sent();
                        if (err_2 instanceof timeout_error_1.TimeoutError) {
                            console.debug('[RUBIC SDK]: Timeout Error. Coingecko cannot retrieve token price');
                        }
                        else if ((_c = err_2 === null || err_2 === void 0 ? void 0 : err_2.message) === null || _c === void 0 ? void 0 : _c.includes('Request failed with status code 429')) {
                            console.debug('[RUBIC SDK]: Too many requests. Coingecko cannot retrieve token price');
                        }
                        else {
                            console.debug(err_2);
    ...
    CoingeckoApi.prototype.getTokenPrice = function (token) {
        if (web3_pure_1.Web3Pure.isNativeAddress(token.address) ||
            token.blockchain === blockchain_name_1.BLOCKCHAIN_NAME.BITCOIN) {
